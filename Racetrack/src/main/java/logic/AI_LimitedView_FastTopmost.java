...
public class AI_LimitedView_FastTopmost extends AI
{
	...
	public AI_LimitedView_FastTopmost( Integer playerID, String name )
	{	
		this( playerID, name, -1 );
	}
	
	public AI_LimitedView_FastTopmost( Integer playerID, String name, int playerColorId )
	{
	...
	{	
		...
		if( !mGridCreated )
		{
			...
			{
				landingPoints.add(lrl.get(i).getFastTopLandingPoint());
			}
