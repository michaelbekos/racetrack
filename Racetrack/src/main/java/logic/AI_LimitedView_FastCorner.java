...
public class AI_LimitedView_FastCorner extends AI
{
	...
	public AI_LimitedView_FastCorner( Integer playerID, String name )
	{	
		this( playerID, name, -1 );
	}
	
	public AI_LimitedView_FastCorner( Integer playerID, String name, int playerColorId )
	{
