...
public class AI_LimitedView_DriveCarefully extends AI
{
	...
	public AI_LimitedView_DriveCarefully( Integer playerID, String name )
	{	
		this( playerID, name, -1 );
	}
	
	public AI_LimitedView_DriveCarefully( Integer playerID, String name, int playerColorId )
	{
