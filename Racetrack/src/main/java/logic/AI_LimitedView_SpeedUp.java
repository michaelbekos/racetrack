...
public class AI_LimitedView_SpeedUp extends AI
{
	...
	public AI_LimitedView_SpeedUp( Integer playerID, String name )
	{	
		this( playerID, name, -1 );
	}
	
	public AI_LimitedView_SpeedUp( Integer playerID, String name, int playerColorId )
	{
	...
	{	
		...
		if( !mGridCreated )
		{
			...
			{
				ArrayList<LandingPoint> tmpTos=lrl.get( i ).getLandingPoints().get();
				int bestSpeed = 0;
