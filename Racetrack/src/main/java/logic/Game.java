	...
	public Game(ILobbyInformation lobby)
	{
		...
		for (int i = 0; i < players.length; i++)
		{
			...
			case 1:
				...
				break;
			case 2:
				players[i]= new AI_NoMover( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 3:
				players[i]= new AI_Random( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 4:
				players[i]= new AI_Puckie( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 5:
				players[i]= new AIstar( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 6:
				players[i]= new AI_Crasher( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 7:
				players[i]= new AI_Zigzag( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 8:
				players[i]= new AI_LimitedView_DriveSafe( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 9:
				players[i]= new AI_LimitedView_FastCorner( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 10:
				players[i]= new AI_LimitedView_FastTopmost( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 11:
				players[i]= new AI_LimitedView_SpeedUp( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;
			case 12:
				players[i]= new AI_Bipartite( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;		
			case 13:
				players[i]= new AI_LimitedView_DriveCarefully( lobby.getPlayerIDs()[i], lobby.getPlayerNames()[i], i );
				break;		
